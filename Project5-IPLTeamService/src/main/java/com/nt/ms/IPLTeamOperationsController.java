...
public class IPLTeamOperationsController {
    ...
    private final IPLTeamRepository IPLTeamRepository;
	@Autowired
	private IPLTeamMgmtService teamService;

    IPLTeamOperationsController(IPLTeamRepository IPLTeamRepository) {
        this.IPLTeamRepository = IPLTeamRepository;
    }
